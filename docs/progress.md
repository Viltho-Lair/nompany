...
**WHAT IS STILL UNVERIFIED:** the customer-unit and contract PICKERS (each renders only where
its register has rows, and the sandbox has no installed base), and the store-backed suite,
