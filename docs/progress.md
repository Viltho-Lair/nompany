...
| **Planner change history, and quotation comparison** | ⏸ WAITING (16/09/2026) | `savePlan` overwrites the plan whole and keeps nothing; undo dies with the page. Quotation revisions exist and nothing shows what changed between them. |
