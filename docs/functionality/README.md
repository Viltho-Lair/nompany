...
| File | Covers |
|---|---|
| [approvals.md](approvals.md) | The Approvals page — steps of named people, who sees what, the records that ask — and the amount chains bills, bids, requisitions and adjustments are signed by today |
...
| [subscriptions.md](subscriptions.md) | Each studio's subscription to nompany: trial, paid, complimentary or lapsed, the dates the status is worked out from, payment events applied once, seats, and the console panel that records them |
