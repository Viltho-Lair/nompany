...
const ar: PlatformStrings = {
  title: "المنصة",
  lead: "أحد عشر قسما على نموذج بيانات واحد. عرض السعر يصبح عقدا، والعقد يفتح مشروعا، والمشروع يصدر طلبات شراء وفواتير — دون اعادة ادخال شيء، لان الجميع يعمل على السجل نفسه.",
  departmentsHeading: "الاقسام",
  departmentsLead: "كل قسم هنا مبني ويعمل اليوم. لا شيء في هذه الصفحة يصف ما لا يمكنك فتحه.",
  foundationHeading: "صحيح في كل الاقسام",
  foundation: [
    {
      title: "صلاحيات حتى مستوى الصف",
      body: "تحسب الصلاحيات مرة واحدة لكل شخص في كل مساحة عمل. من لا دور له لا يملك شيئا — ولا يوجد مسار احتياطي يمنح المزيد بصمت. والمدير المحدود بقسم يرى قسمه وكل ما تحته، ولا يستطيع احد منح صلاحية لا يملكها هو.",
    },
    {
      title: "العربية والإنجليزية، بانعكاس صحيح",
      body: "ليست طبقة ترجمة فوق منتج انجليزي. الاتجاه والخطوط ومكتبة الواجهة كلها تنعكس، ولكل شخص ان يختار لغته بدل ان يرث لغة الشركة.",
    },
    {
      title: "تحديث حي بلا اعادة تحميل",
      body: "ما يغيره شخص يظهر لكل من ينظر الى السجلات نفسها. وعند عودة الاتصال يعاد ما فات بدل ان يضيع.",
    },
    {
      title: "بياناتك تبقى لك",
      body: "كل سجل يخص مساحة عمل واحدة ومسيّج على مستوى قاعدة البيانات، لا مجرد مصفّى في التطبيق. والملفات لا تقدم الا بعد فحص العضوية نفسه الذي تمر به الشاشات.",
    },
  ],
  blurbs: {
    "crm-sales":
      "العملاء المحتملون والصفقات واللوحة التي تتحرك عليها. ولكل عميل صفحته: ما اشتراه، وما هو مفتوح، وما ربح وما خسر، والاسعار التي وعد بها. عروض الاسعار تسعّر من تلك الاسعار لا من التكلفة، وعرض السعر الفائز يصبح عقدا تتبع تغييراته عليه.",
    tendering:
      "المناقصات مرتبة بالموعد النهائي لا بتاريخ الادخال، لان اغلبها ينتهي بقرار عدم التقديم، وتسجيل الفائزة وحدها يفقدك القدرة على معرفة ما تخسره باستمرار. جداول كميات تسعّر من مكتبة اسعار قابلة لاعادة الاستخدام، وحزمة مناقصة لا تمحو اصداراتها الجديدة ما سعّرت عليه، وتوقيع مطلوب قبل تقديم العطاء.",
    projects:
      "خطة بعلاقات ومدد ومسار حرج. وتفصيل تكلفة يقول كم يسمح للعمل ان يكلف، وكم طلب، وكم فوتر، والى اين وصل العمل فعلا مقابل ذلك كله. ودفعات الفوترة والمحتجزات على الوجه الاخر للمشروع نفسه.",
    "engineering-docs":
      "سجل الوثائق المضبوطة — المخططات والمواصفات واصداراتها ومن اطلع على اي منها. والاصدار المستبدل يوسم ولا يحذف، لان ما بنيت عليه يجب ان يبقى قابلا للمساءلة.",
    procurement:
      "طلب الشراء هو اول مستند يمكن رفضه بثمن زهيد، قبل ان يوجد التزام. الطلبات المعتمدة تتحول الى امر شراء، والموردون يقيمون على ما سلموه فعلا، ولعقود الباطن نطاقها ومستخلصاتها.",
    inventory:
      "المخزون عبر المواقع، وما طلب وما وصل وما رفض عند الاستلام. وتتبع بالرقم التسلسلي او الدفعة حيث يحتاج الصنف ذلك.",
    "field-service":
      "مهام توزع على من ليسوا خلف مكتب، والورديات التي يعملونها، وتقارير الموقع التي يرفعونها. وتصاريح العمل حيث يلزم.",
    logistics:
      "التسليمات والمركبات التي تنفذها وتكلفة كل رحلة. وصيانة الاسطول مجدولة على المركبة لا على التقويم.",
    hr: "الافراد واقسامهم والادوار التي تحدد ما يفتحونه. واجازات تحترم الهيكل التنظيمي، وساعات عمل تصل الى تكاليف المشروع.",
    finance:
      "الفواتير والمطالبات والحسابات التي تقيد عليها. والمطالبات فوق حد تحدده تحتاج توقيعا ثانيا، وسعر الصرف الذي وجّه المطالبة يحفظ عليها، فلا يعيد تغير السعر ليلا توجيه مطالبة بدأت اعتمادها. 166 عملة باسعار يومية.",
    administration:
      "من في مساحة العمل، وما الذي يصله كل دور، والهيكل التنظيمي والمواقع والاعدادات التي تقرأها بقية الاقسام. والادوار تتبع الاقسام — مهندس الموقع يعرض على قسم تنفيذ لا على قسم مبيعات.",
  },
};
