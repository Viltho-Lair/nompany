...
const ar: PlatformStrings = {
  ...
  foundation: [
    ...
    },
    {
      ...
      body: "كل سجل يخص مساحة عمل واحدة ومسيج على مستوى قاعدة البيانات، لا مجرد مصفى في التطبيق. والملفات لا تقدم الا بعد فحص العضوية نفسه الذي تمر به الشاشات.",
    },
  ],
  blurbs: {
    "crm-sales":
      "العملاء المحتملون والصفقات واللوحة التي تتحرك عليها. ولكل عميل صفحته: ما اشتراه، وما هو مفتوح، وما ربح وما خسر، والاسعار التي وعد بها. عروض الاسعار تسعر من تلك الاسعار لا من التكلفة، وعرض السعر الفائز يصبح عقدا تتبع تغييراته عليه.",
    tendering:
      "المناقصات مرتبة بالموعد النهائي لا بتاريخ الادخال، لان اغلبها ينتهي بقرار عدم التقديم، وتسجيل الفائزة وحدها يفقدك القدرة على معرفة ما تخسره باستمرار. جداول كميات تسعر من مكتبة اسعار قابلة لاعادة الاستخدام، وحزمة مناقصة لا تمحو اصداراتها الجديدة ما سعرت عليه، وتوقيع مطلوب قبل تقديم العطاء.",
    projects:
    ...
    finance:
      "الفواتير والمطالبات والحسابات التي تقيد عليها. والمطالبات فوق حد تحدده تحتاج توقيعا ثانيا، وسعر الصرف الذي وجه المطالبة يحفظ عليها، فلا يعيد تغير السعر ليلا توجيه مطالبة بدأت اعتمادها. 166 عملة باسعار يومية.",
    administration:
