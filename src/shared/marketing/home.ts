...
const ar: HomeStrings = {
  whatEyebrow: "ما هو",
  whatTitle: "نظام واحد، لا تسعة انظمة تتحدث الى بعضها",
  whatBody:
    "اغلب الشركات تشغل اداة مختلفة لكل قسم، ثم تقضي اسبوعها في التوفيق بينها. نومباني نظام واحد بنموذج بيانات واحد تحته: عرض السعر يصبح عقدا، والعقد يفتح مشروعا، والمشروع يصدر طلبات شراء وفواتير، والسجل نفسه يمر بذلك كله. لا شيء يعاد ادخاله، لانه لا يوجد مكان اخر يعاد ادخاله فيه.",
  departmentsTitle: "احد عشر قسما، مبنية وتعمل",
  departmentsLead:
    "ليست خطة مستقبلية. كل قسم منها يفتح على شاشة تستطيع استخدامها اليوم، وهذه القائمة تقرأ من البرنامج نفسه لا تكتب هنا — فلا يمكنها ان تعد بقسم غير موجود.",
  departmentsCta: "اطلع على ما يفعله كل قسم",
  pricingTitle: "مجاني حتى تصبحوا عشرة",
  pricingLead:
    "المنتج كاملا، بكل اقسامه، للفرق من واحد الى تسعة. والخطط المدفوعة تبدأ من عشرة، بسعر لكل موظف شهريا شامل ضريبة القيمة المضافة. بلا بطاقة للبدء، وبلا مكالمة تجلس فيها.",
  pricingCta: "اطلع على الاسعار",
  closingTitle: "ابدأ بعرض سعرك القادم",
  closingLead:
    "افتح مساحة عمل، وادع من يحتاجها، واترك لكل واحد لغته. لا شيء يثبّت، ولا شيء يرحّل في اليوم الاول.",
};
