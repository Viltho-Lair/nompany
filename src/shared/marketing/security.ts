...
const ar: SecurityStrings = {
  title: "الأمان",
  lead: "ما الذي يحمي بياناتك فعلا، موصوفا بحيث يمكنك التحقق منه — وقائمة صريحة كذلك بما لا نملكه من شهادات.",
  practicesHeading: "ما هو قائم",
  practices: [
    {
      title: "سجلات كل مستأجر معزولة على مستوى قاعدة البيانات",
    ...
    },
    {
      ...
      body: "ما يحفظ هو بصمة SHA-256 للرمز لا الرمز نفسه. فمن يقرأ المخزن يجد قيما لا يمكن استخدامها كجلسة، ويمكن إنهاء جلسة واحدة ببصمتها دون المساس بالباقي.",
      source: "src/platform/auth/superAuth.ts",
    },
    {
      title: "محاولات كلمة المرور المتكررة تبطأ ثم توقف",
      body: "تحصى المحاولات الفاشلة بثلاث طرق — بالمصدر وبالحساب وبالاثنين معا — والمصدر الذي يستمر بالفشل يمنع مددا تطول تدريجيا. وثلاثة عدادات لا واحد عن قصد: حد واحد على مستوى الحساب يمنح أي شخص وسيلة لحبس صاحبه خارج حسابه بمجرد كتابة عنوانه خطأ.",
      source: "src/platform/auth/attempts.ts",
    },
    {
      title: "لوحة التحكم تتطلب عاملا ثانيا",
      body: "لوحة الإدارة التي تصل عبر مساحات العمل محمية بالتحقق متعدد العوامل، بشكل منفصل عن تسجيل الدخول إلى المنتج.",
      source: "src/platform/auth/superMfa.ts",
    },
    {
      title: "كل تغيير يسجل، من مكان واحد",
      body: "كل تعديل يسجل من قام به، وبأي هوية، وفي أي مساحة عمل، وماذا فعل، وعلى أي سجل، وبماذا أجيب. ويكتبه الغلاف الواحد الذي يمر به كل طلب تعديل أصلا — فهو مكان واحد يمكن إتقانه بدل سبعة وتسعين مكانا يمكن نسيانها.",
      source: "src/platform/http/audit.ts",
    },
    {
    ...
    },
    {
      ...
      body: "HSTS لمدة سنتين، ومنع التأطير تماما، وتعطيل استنتاج نوع المحتوى، وإيقاف الموقع والكاميرا والميكروفون والدفع وUSB بالسياسة. ولا يحمل الموقع أي جافاسكربت من طرف ثالث — لا مدير وسوم ولا نافذة محادثة ولا سكربت تحليلات — فلا يوجد طرف ثالث نأتمنه على زوارك.",
      source: "next.config",
    },
  ],
