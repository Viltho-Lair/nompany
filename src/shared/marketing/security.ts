...
const ar: SecurityStrings = {
  ...
  practices: [
    {
      title: "سجلات كل مستأجر مسيجة على مستوى قاعدة البيانات",
    ...
    },
    {
      ...
      body: "HSTS لمدة سنتين، ومنع التأطير تماما، وتعطيل استنتاج نوع المحتوى، وايقاف الموقع والكاميرا والميكروفون والدفع وUSB بالسياسة. ولا يحمل الموقع اي جافاسكربت من طرف ثالث — لا مدير وسوم ولا نافذة محادثة ولا سكربت تحليلات — فلا يوجد طرف ثالث نأتمنه على زوارك.",
      source: "next.config",
    },
  ],
