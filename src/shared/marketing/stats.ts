...
const en: StatsStrings = {
  ...
  factDepartments: "Seventeen departments on one data model, every one of them open today.",
...
const ar: StatsStrings = {
  heading: "أين وصلنا",
  factDepartments: "سبعة عشر قسما على نموذج بيانات واحد، وكلها مفتوحة اليوم.",
