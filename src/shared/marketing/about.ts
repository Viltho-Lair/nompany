...
const en: AboutStrings = {
  ...
  whatBody:
    "nompany is an ERP: one place for sales and quotations, tendering, projects, engineering documents, procurement, inventory, manufacturing, field service, logistics, assets and maintenance, quality and safety, people, finance, marketing, a point of sale and reporting — with a single data model underneath, so what one team enters the next one already has. It is built for small and medium companies across the region, in Arabic and English, and it is free until you are ten people.",
