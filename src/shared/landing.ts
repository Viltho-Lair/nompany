...
const en: Strings = {
  ...
  pvAs2Body: "Micro is free for the first 3 months for up to 4 employees — English and Arabic, RTL-ready, no card required.",
...
const ar: Strings = {
  ...
  pvAs2Body: "خطة مايكرو مجانية لأول 3 أشهر حتى أربعة موظفين — بالعربية والإنجليزية، وبدعم كامل للاتجاهين، وبلا بطاقة.",
