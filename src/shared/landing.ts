...
const en: Strings = {
  ...
  pvAs2Body: "Micro is free for the first 3 months for up to 9 employees — English and Arabic, RTL-ready, no card required.",
  pvAs2Title: "3 months free under ten people",
  ...
  pvLead: "Priced by your team size — start free for 3 months with up to 9 users, then choose the plan that fits your headcount. Every plan includes the full platform.",
  pvMonthly: "Monthly",
...
const ar: Strings = {
  ...
  pvAs2Body: "خطة مايكرو مجانية لأول 3 أشهر حتى تسعة موظفين — بالعربية والإنجليزية، وبدعم كامل للاتجاهين، وبلا بطاقة.",
  pvAs2Title: "3 أشهر مجانا تحت العشرة",
  ...
  pvLead: "السعر بحسب حجم فريقك — ابدأ مجانا لمدة 3 أشهر حتى تسعة مستخدمين، ثم اختر الخطة التي تناسب عدد موظفيك. وكل خطة تشمل المنصة كاملة.",
  pvMonthly: "شهري",
