...
const en: Strings = {
  ...
  pvAs2Body: "Standard is free for the first 3 months for up to 4 employees — English and Arabic, RTL-ready, no card required.",
  pvAs2Title: "3 months free under five people",
  ...
  pvLead: "Priced by your team size — start free for 3 months with up to 4 users, then choose the plan that fits your headcount. Every plan includes the full platform.",
  pvMonthly: "Monthly",
...
const ar: Strings = {
  ...
  pvAs2Body: "الباقة الأساسية مجانية لأول 3 أشهر حتى أربعة موظفين — بالعربية والإنجليزية، وبدعم كامل للاتجاهين، وبلا بطاقة.",
  pvAs2Title: "3 أشهر مجانا تحت الخمسة",
  ...
  pvLead: "السعر بحسب حجم فريقك — ابدأ مجانا لمدة 3 أشهر حتى أربعة مستخدمين، ثم اختر الخطة التي تناسب عدد موظفيك. وكل خطة تشمل المنصة كاملة.",
  pvMonthly: "شهري",
