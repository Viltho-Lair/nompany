...
// THE SECURITY SURFACES' WORDS — device types, the session list, the lock
...
const en = {
  ...
  sessionsBlurb: "Every device signed in to your account right now. Sign out any you don't recognise.",
  ...
  idleWarn: (s: number) => `Locking in ${s} second${s === 1 ? "" : "s"} — still here?`,
  idleStay: "I'm here",
  pinLabel: "PIN",
  unlock: "Unlock",
  unlocking: "Checking…",
...
const ar: typeof en = {
  ...
  sessionsBlurb: "كل جهاز مسجل الدخول إلى حسابك الآن. سجّل خروج أي جهاز لا تعرفه.",
  ...
  idleWarn: (s: number) => `سيتم القفل خلال ${s} ثانية — هل ما زلت هنا؟`,
  idleStay: "أنا هنا",
