...
const en: Strings = {
  ...
  notYet: "Not built yet: a report builder, saved and scheduled reports, analytics, and KPI targets with alert rules.",
};
...
const ar: Strings = {
  ...
  notYet: "غير مبني بعد: منشئ التقارير، والتقارير المحفوظة والمجدولة، والتحليلات، ومؤشرات الأداء وقواعد التنبيه.",
};
