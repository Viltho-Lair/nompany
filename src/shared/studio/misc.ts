...
const ar: Strings = {
  ...
  chatsArentStored: "لا تحفظ المحادثات. وحين تنتهي يمكنك تنزيل النص — وبعدها يختفي من جانبنا أيضا.",
  ...
  chatNompany: "تحدث مع nompany",
  chooseFile: "اختر ملفا",
  city: "المدينة",
  clientBudget: "ميزانية العميل",
  close: "إغلاق",
  closeNova: "إغلاق نوفا",
  commentDidnSave: "لم يحفظ ذلك التعليق.",
  comments: "التعليقات",
  confirm: "تأكيد",
  consumedAllTickets: "استهلكت كل تذاكر هذا الشهر.",
  contactPerson: "جهة الاتصال",
  couldNotStartChat: "تعذر بدء المحادثة.",
  couldntReachServer: "تعذر الوصول إلى الخادم. حاول مرة أخرى.",
  couldntReachServerNoChange: "تعذر الوصول إلى الخادم، فلم يتغير شيء.",
  country: "الدولة",
  deadline: "الموعد النهائي",
  description: "الوصف",
  didnGoThrough: "لم تتم العملية.",
  didnSave: "لم يحفظ ذلك.",
  didnSendTryAgain: "لم يرسل ذلك. حاول مرة أخرى.",
  documentation: "التوثيق",
  download: "تنزيل",
  downloadTranscript: "نزل النص",
  edit: "تعديل",
  email: "البريد الإلكتروني",
  endChatDownload: "أنه المحادثة ونزل",
  exInvoicesOverdue: "أي الفواتير متأخرة؟",
  exRemainingLeave: "كم تبقى من إجازتي؟",
  exSummariseFinances: "لخص وضعنا المالي",
  exTaskBoard: "ما الموجود في لوحة مهامي؟",
  fieldsMarkedRequired: "الحقول المعلمة بـ * مطلوبة.",
  fileDidnUpload: "لم يرفع ذلك الملف.",
  fileTooLarge5: "هذا الملف كبير جدا — الحد 5 ميجابايت.",
  goesWhoeverHoldsManagement: "يذهب إلى من يحمل صلاحيتي الإدارة والمالية في إعدادات المهام. وتصدر المالية رقم المشروع.",
  ...
  sendTicketBackTechnical: "أعد هذه التذكرة إلى القسم الفني لمراجعة آخر عرض سعر",
  sending: "جار الإرسال…",
  ...
  ticketQuotationApprovedNothing: "اعتمد عرض سعر هذه التذكرة — لم يبق ما يراجع. وأي تغيير بعد الاعتماد يعني تذكرة جديدة.",
  ticketTimeline: "المسار الزمني للتذكرة",
  typeMessage: "اكتب رسالة…",
  unassigned3: "غير مسند",
  urgency: "الاستعجال",
  usuallyReplyFewMinutes: "نرد عادة خلال دقائق",
  ...
  whatClientSentFinance: "ما أرسله العميل. تعتمده المالية وتصدر رقم المشروع الذي يحاسب عليه العمل.",
