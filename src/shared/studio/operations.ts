...
const ar: Strings = {
  ...
  coordinatesUnreadable: "لا يوجد موقع في هذا النص. اكتب زوجا مثل 31.9539، 35.9106، أو الصق رابط خريطة، أو حدد المكان على الخريطة.",
  ...
  directionsHint: "كيف تجده عند الوصول — معلم قريب أو بوابة أو طابق",
  ...
  accuracyPoor: (m) => `الدقة تقارب ${m} م فقط — اخرج إلى مكان مفتوح، أو حدد المكان على الخريطة.`,
  navigate: "الاتجاهات",
  copyCoordinates: "نسخ الإحداثيات",
  noPin: "بلا دبوس",
  pinsOnMap: (n, total) => `${n} من ${total} على الخريطة`,
  noPinsYet: "لا يوجد موقع عليه دبوس بعد. عدل أحد المواقع وأضف إحداثياته ليظهر على الخريطة.",
  name: "الاسم",
