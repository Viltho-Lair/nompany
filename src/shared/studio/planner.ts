...
const ar: Strings = {
  ...
  availabilityChecking: "جار التحقق…",
  availabilityConnectInAccount: "اربط تقويما من إعدادات حسابك",
  availabilityFree: "متفرغ",
  availabilityNoCalendar: "لا يوجد تقويم مرتبط بحسابك، فلا شيء لمشاركته بعد.",
  availabilityNoCalendarConnected: "لا تقويم مرتبط",
  availabilityNobodyAssigned: "لم يسند أحد إلى هذه الخطة بعد.",
  availabilityNotShared: "غير مشارك",
  availabilityOutsideWindow: "لم يفحص",
  availabilityShareFailed: "تعذر حفظ هذا. حاول مرة أخرى.",
  availabilityShareHint: "يرى الزملاء متى تكون مشغولا — لا ماذا تفعل ولا أين ولا مع من.",
  availabilityShareLabel: "اسمح لزملائي في هذا الاستوديو برؤية أوقات انشغالي",
  availabilityShareUnreadable: "تعذرت قراءة إعداد المشاركة، فلا يمكن تغييره هنا الآن.",
  availabilityUnavailable: "تعذر التحقق",
  byAssignee: "المسؤول",
  byPhase: "المرحلة",
  byPriority: "الأولوية",
  byStatus: "الحالة",
  calendarDaysWord: "يوما تقويميا",
  cancel: "إلغاء",
  choosePreset: "اختر إعدادا جاهزا",
  clearAll: "امسح الكل",
  colAssignee: "المسؤول",
  colDuration: "المدة",
  colEffort: "الجهد (س)",
  ...
  nSchedulingIssues: (n) =>
    ...
    : n <= 10 ? `${n} مشاكل جدولة`
    : `${n} مشكلة جدولة`,
  collapseAllPhases: "اطو كل المراحل",
  colorBy: "اللون",
  convertToMilestone: "حول إلى معلم",
  convertToTask: "حول إلى مهمة",
  critical: "حرجة",
  ...
  defaultsCouldNotSaved: "تعذر حفظ الإعدادات الافتراضية. حاول مرة أخرى.",
  details: "التفاصيل",
  duplicate: "تكرار",
  duration: "المدة",
  edit: "تعديل",
  ...
  fromStudioWorkingHours: "من ساعات عمل الاستوديو — غيرها في إعدادات الاستوديو.",
  generateWorkBreakdown: "ولد هيكل عمل من إعداد جاهز، أو أضف صفك الأول وابن المخطط من الصفر. والصفوف الفرعية تحول الصف الأب إلى قوس تجميعي تلقائيا.",
  gridColumns: "أعمدة الجدول",
  highlightLongestPathThrough: "إبراز أطول مسار خلال الخطة",
  hold: "معلقة",
  hours: "الساعات",
  howNewPlanOpens: "كيف تفتح الخطة الجديدة أول مرة تعرض فيها. أما أسبوع العمل والأشخاص فيأتيان من الاستوديو نفسه.",
  howNewPlanOpens2: "كيف تفتح الخطة الجديدة أول مرة تعرض فيها.",
  indent: "إزاحة للداخل",
  issueCircular: "اعتماد دائري — تجوهل هذه الصلة",
  issuePinnedTooEarly: "البداية المثبتة أبكر مما تسمح به سوابقها",
  issueSelfDependency: "لا يمكن أن تعتمد المهمة على نفسها",
  lastChangeNotSaved: "تعذر حفظ آخر تغيير. تحقق من اتصالك أو صلاحيتك ثم عدل مرة أخرى.",
  link: "الربط من",
  links: "الروابط",
  loadingTemplates: "جار تحميل القوالب…",
  new: "جديدة",
  ...
  phAtRisk: "معرضة للخطر",
  phOffTrack: "خارج المسار",
  phOnHold: "معلقة",
  phOnTrack: "على المسار",
  pickTemplateLayout: "اختر قالبا يبنى منه هذا المخطط. والقالب يحمل روابط اعتماده الخاصة، فيرسم المخطط جدوله الزمني بنفسه. وتنشأ القوالب وتعدل في صفحة المخطط الرئيسية، لا هنا.",
  pinStartDate: "ثبت تاريخ البدء",
  pinned: "مثبت",
  pinnedStart: "بداية مثبتة — تتجاهل المهام السابقة",
  pinnedStart2: "بداية مثبتة — تتجاهل المهام السابقة",
  planCouldNotLoad: "تعذر تحميل هذا المخطط — قد لا تملك الوصول إليه.",
  plans: "المخططات",
  plansCouldNotLoad: "تعذر تحميل هذه المخططات — قد لا تملك الوصول إلى المخطط.",
  ...
  saving: "جار الحفظ…",
  scheduling: "الجدولة",
  selectRowToEdit: "اختر صفا لعرض تفاصيله وتعديلها.",
  showDependencyArrows: "إظهار أسهم الاعتماديات",
  stAtRisk: "معرضة للخطر",
  stBlocked: "متوقفة",
  stComplete: "مكتملة",
  ...
  toStartExternal: "لبدء جدول خارجي، أو افتح مشروعا واستخدم إجراء",
  today: "اليوم",
  track: "على المسار",
  trimWaterfallOneDay: "قص المخطط إلى يوم واحد على جانبي العمل",
