...
const areas: Record<Locale, Record<string, string>> = {
  ...
  ar: {
    ...
    "crmSales.insights": "تحليلات العملاء",
    "tendering.tenders": "سجل المناقصات",
...
const extras: Record<Locale, Record<string, string>> = {
  ...
  ar: {
    ...
    "crmSales.insights.export": "تنزيل قائمة العملاء",
    "crmSales.insights.act": "إرسال العملاء إلى المبيعات كعملاء محتملين",
    ...
    "pos.promotions.applyManual": "اختيار عرض عند الصندوق",
    "pos.promotions.removeAuto": "إزالة عرض طبقه الصندوق",
