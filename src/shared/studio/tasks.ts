...
const ar: Strings = {
  ...
  appointSomeoneTaskSettings: "عين شخصا من إعدادات المهام",
  approve: "اعتماد",
  approvedByOn: (who, when) => `اعتمدها ${who}${when ? ` في ${when}` : ""}`,
  approvedOpenProject: "معتمد — افتح المشروع",
  nOfMApproved: (approved, required) => `اعتمد ${approved} من ${required}`,
  showLess: "أقل",
  someone: "أحدهم",
  showMore: "المزيد",
  ...
  assign: "إسناد إلى",
  authorityIsnPartTask: "هذه السلطة ليست جزءا من هذه المهمة.",
  blankOrdinaryTaskAssigned: "الفراغ يعني مهمة عادية — مسندة إلى شخص.",
  canMoveTaskTick: "يمكنك تحريك مهمتك وتعليم قائمة التحقق الخاصة بها — أما البقية فتغييرها للمدير.",
  canOnlyChangeTasks: "لا يمكنك تغيير سوى المهام المسندة إليك.",
  canOpenProjects: "لا يمكنك فتح المشاريع.",
  cancel: "إلغاء",
  checklist: "قائمة التحقق",
  createProjectSheet: "إنشاء المشروع والكشف",
  createTaskAssignSomeone: "أنشئ مهمة وأسندها إلى شخص في هذا الاستوديو.",
  ...
  everyKindOfTask: "كل نوع من المهام التي يرفعها الاستوديو، ومن يبت فيه. وتعيين شخص يوجه إليه المهام المطابقة فورا، بما فيها القائمة — إذ يقرأ الإسناد من هنا مع كل تحميل، ولا ينسخ على المهمة، فلا يظل أبدا مشيرا إلى من كان يشغل الوظيفة.",
  giveTaskTitle: "أعط المهمة عنوانا.",
  kind: "النوع",
  kindFixed: "يثبت نوع المهمة بمجرد وجودها.",
  loadingTasks: "جار تحميل المهام…",
  member: "عضو",
  needsYourDecision: "تحتاج إلى قرارك",
  newTask: "مهمة جديدة",
  noOpenTasks: "لا توجد مهام مفتوحة",
  nobody: "لا أحد",
  nobodyAppointed: "لم يعين أحد",
  nobodyAppointedAuthorityYet: "لم يعين أحد لهذه السلطة بعد",
  nobodyStudioYet: "لا أحد في هذا الاستوديو بعد",
  nothingAssigned: "لا شيء مسند إليك",
  nothingFinishedYet: "لم ينجز شيء بعد",
  nothingOverdue: "لا شيء متأخر",
  oneAuthoritySigns: "سلطة واحدة توقع",
  ...
  raisedOnBoard: "رفعت في لوحة المهام.",
  save: "حفظ",
  ...
  saving2: "جار الحفظ…",
  task: "المهمة",
  taskDecisionSystemRaised: "هذه المهمة قرار رفعه النظام — لا يمكن تعديلها أو حذفها. اسحب الاعتماد بدلا من ذلك.",
  taskIsnApproval: "هذه المهمة ليست اعتمادا.",
  taskSettings: "إعدادات المهام",
  tasks: "مهام",
  tasksAssignedWillAppear: "ستظهر هنا المهام المسندة إليك.",
  tasksOnly: "مهامك فقط",
  title: "العنوان",
  unassigned: "غير مسندة",
  unassigned2: "غير مسندة",
