...
export const commonAr: CommonStrings = {
  ...
  loadFailed: "تعذر تحميل ذلك.",
  nameInUse: "هذا الاسم مستخدم بالفعل.",
  nothingRecorded: "لم يسجل شيء بعد.",
  ...
  dashboardLockedBody:
    "يبقي هذا الاستوديو لوحات معلومات الوحدات خلف صلاحية خاصة بها. الشاشات التي تحتها غير متأثرة — اختر واحدة من الشريط الجانبي.",
