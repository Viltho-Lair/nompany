...
const ar: Strings = {
  ...
  cancel: "إلغاء",
  changesSavedType: "تحفظ التغييرات أثناء الكتابة.",
  ...
  doubleClickRename: "انقر نقرا مزدوجا لإعادة التسمية",
  dropCardHereClick: "أفلت بطاقة هنا أو انقر للإضافة",
  duplicate: "تكرار",
  duplicateColumn: "كرر العمود",
