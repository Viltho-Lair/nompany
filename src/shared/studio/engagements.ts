...
const ar: Strings = {
  ...
  dealAppearsMoment: "تظهر الصفقة هنا لحظة بدئها في أي مكان من الاستوديو — تذكرة، أو طلب عرض سعر، أو عرض سعر أنشئ وحده.",
  delete: "حذف",
  deleteDealAndRecords: (n: number) => `احذف الصفقة و${n === 1 ? "سجلا واحدا" : n === 2 ? "سجلين" : n <= 10 ? `${n} سجلات` : `${n} سجلا`}`,
  ...
  nRecords: (n: number) => n === 1 ? "سجل واحد" : n === 2 ? "سجلان" : n <= 10 ? `${n} سجلات` : `${n} سجلا`,
  noStageYet: (what) => `لا يوجد ${what} بعد.`,
  nothingBorrowed: "لم يستعر شيء من مكان آخر — كل ما على هذه الصفقة أنشئ عليها.",
  ...
  client: "العميل",
  couldNotWorkOut: "تعذر تحديد ما سيتأثر بحذف هذا، لذا ليس من الآمن عرض الزر.",
  dealLockedAgainNothing: "أقفلت هذه الصفقة من جديد. لا يمكن حذف أي شيء حتى يفتح القفل.",
  dealLockedAgainWhile: "أقفلت هذه الصفقة من جديد أثناء اتخاذك القرار. لم يحذف شيء — افتح القفل مرة أخرى إن كنت لا تزال تريد حذفها.",
  deleting: "جار الحذف…",
  didNotGoThrough: "لم تتم العملية. حاول مرة أخرى.",
  didNotGoThrough2: "لم تتم العملية، ولم يحذف شيء. حاول مرة أخرى.",
  engagement: "الارتباط",
  engagementNoLongerExists: "لم يعد هذا الارتباط موجودا.",
  ...
  loading: "جار التحميل…",
  loadingEngagement: "جار تحميل الارتباط",
  loadingEngagements: "جار تحميل الارتباطات",
  lock: "قفل",
  locked: "مقفل",
  ...
  noClientOnFile: "لا يوجد عميل مسجل",
  noClientOnFile2: "لا يوجد عميل مسجل",
  noEngagementsCanSee: "لا توجد ارتباطات يمكنك رؤيتها في هذه الصفحة",
  noLongerAllowedDelete: "لم يعد مسموحا لك بحذف هذه الصفقة.",
  notAllowedLockUnlock: "لا يسمح لك بقفل الصفقات أو فتحها في هذا الاستوديو.",
  ...
  workingOutWhatDeleting: "جار تحديد ما سيتأثر بحذف هذا",
};
