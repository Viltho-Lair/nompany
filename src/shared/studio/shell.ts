...
const ar: ShellStrings = {
  ...
  offlineTitle: "لا تصل التحديثات المباشرة — جار إعادة الاتصال",
  offlineBanner: "لا تصل التحديثات المباشرة. جار إعادة الاتصال…",
  nothingYet: "لا شيء بعد.",
  loading: "جار التحميل…",
  deniedAccessBody: "يلزم أن تكون مسؤولا في هذا الاستوديو لإدارة الصلاحيات.",
  ...
  nothingGrantedBody:
    "أنت عضو في هذا الاستوديو، لكن لم يمنح لك أي قسم. يمكن لمسؤول فعل ذلك من شاشة الصلاحيات.",
