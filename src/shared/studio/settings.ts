...
const ar: Strings = {
  ...
  loadFailed: "تعذر تحميل إعدادات هذا الاستوديو.",
  ...
  country: "الدولة",
  city: "المدينة",
  cityNeedsCountry: "اختر الدولة أولا.",
  location: "الموقع",
  currency: "العملة",
  ...
  deleteScheduled:
    "مجدول للحذف. يستمر كل شيء في العمل حتى ذلك الحين، والإلغاء يتراجع عنه تماما.",
  ...
  confirmReversible:
    "يمكنك الإلغاء في أي وقت خلال تلك الثلاثين يوما ويستمر الاستوديو كأنك لم تطلب ذلك قط.",
  ...
  favNone: "لم تختر أي عملة بعد.",
  favNeedsBase: "حدد عملة الاستوديو أعلاه لتظهر هذه بسعر صرف مقابلها.",
  favBase: "الأساس",
  ...
  hoursLead: "الأيام والساعات التي يعمل فيها هذا الاستوديو. أطفئ يوما لتحديده مغلقا.",
  hoursSaveFailed: "تعذر حفظ تلك الساعات.",
  dayNames: {
  ...
  logoLead:
    "يقف أعلى هذا الاستوديو بدلا من شعار nompany، وعلى بطاقة الاستوديو في حساب كل من يعمل فيه.",
  pickImage: "اختر ملف صورة.",
  imageTooBig: "يجب ألا تتجاوز الصور 2 ميجابايت.",
  uploadFailed: "تعذر رفع ذلك الشعار.",
  removeFailed: "تعذر إزالة ذلك الشعار.",
  uploading: "جار الرفع…",
  change: "تغيير",
  remove: "إزالة",
  ...
  flowsLoadFailed: "تعذر تحميل المسارات.",
  flowBuiltIn: "جاهز",
  flowEdited: "معدل",
  flowYours: "خاص بكم",
  flowStagesLabel: "المراحل، بالترتيب الذي تمر به الصفقة",
  flowHeadsLabel: "يمكنه بدء صفقة",
  flowStatusChainLabel: "يتحدث باسم الصفقة — الأعلى أولا",
  flowCostDriversLabel: "يحتسب تكلفة",
  flowBillingLabel: "تفوتر عند",
  ...
  flowDelete: "حذف",
  flowNoStages: "لا مراحل بعد — صفقة على هذا المسار لن تعرض شيئا.",
  flowRefused: (why) => `رفض هذا المسار: ${why}`,
  ...
  flowConfirmEdit: (n, name) => `${n === 1 ? "صفقة واحدة تسير" : n === 2 ? "صفقتان تسيران" : n <= 10 ? `${n} صفقات تسير` : `${n} صفقة تسير`} على ${name}. تعديله يغير ما تعرضه، وما يبقى مطلوبا منها، وما يمكن ربطه بها من الآن.`,
  ...
  flowConfirmKept: "لا يحذف أي سجل. المرحلة التي لم يعد المسار يذكرها تبقى ظاهرة على الصفقات التي تملكها، موسومة بأنها خارج المسار.",
  flowConfirmOrphans: (names) => `هذه القطاعات تبدأ صفقاتها هنا وستبقى تشير إلى لا شيء: ${names}.`,
  flowConfirmGo: "أفهم ذلك — نفذ التغيير",
