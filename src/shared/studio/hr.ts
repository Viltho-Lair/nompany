...
const en: Strings = {
  ...
  studioSectionsWhereThey: "Your studio's departments. Manage the list in Master data.",
  submit: "Submit",
...
const ar: Strings = {
  ...
  libraryNeedsIndustry: "حدد مجال عمل الاستوديو في إعدادات الاستوديو، ليعرف الدليل الأدوار المستخدمة في هذا المجال.",
  libraryNeedsCode: "امنح هذا القسم رمزا في البيانات الأساسية، ليعرف الدليل الأدوار التابعة له.",
  ...
  canOnlyGiveSomebody: "لا يمكنك منح شخص دورا إلا إن كنت تملك صلاحياته بنفسك.",
  cancel: "إلغاء",
  certificationsHeld: "الشهادات المحرزة",
  dashboardIsnYoursSee: "لوحة المعلومات ليست من صلاحياتك",
  dateJoining: "تاريخ الالتحاق",
  days: "الأيام",
  decline: "رفض",
  defineQualificationsPeopleHold: "عرف المؤهلات التي يحملها موظفوك، ثم علم عليها لدى كل شخص.",
  delete: "حذف",
  ...
  namingJobHrWhat: "تسمية الوظيفة من شأن الموارد البشرية. أما ما يسمح لها بفعله فيضبط في شاشة الصلاحيات.",
  newCertification: "شهادة جديدة",
  newRole: "دور جديد",
  noAccessGrantedYet: "لم تمنح أي صلاحيات بعد",
  noCertificationsYet: "لا توجد شهادات بعد",
  noDocumentsFile: "لا توجد وثائق مسجلة",
  noLeaveBooked: "لا توجد إجازات محجوزة",
  noLeaveBookedYet: "لم تحجز أي إجازة بعد.",
  noOneHereMatches: "لا أحد هنا يطابق هذا البحث.",
  noRolesDefinedYet: "لم تعرف أي أدوار بعد.",
  nobodyBookedAway: "لا أحد محجوز للغياب.",
  nobodyHereYet: "لا أحد هنا بعد",
  nobodyMatches: "لا أحد يطابق",
  nobodyPlacedDepartmentYet: "لم يوضع أحد في قسم بعد.",
  notPlacedYet: "لم يوضع بعد",
  notes: "ملاحظات",
  ...
  puttingSomebodyRoleAccess: "وضع شخص في دور تغيير للصلاحيات، وهذا يضبط في شاشة الصلاحيات.",
  reason: "السبب",
  rename: "إعادة تسمية",
  ...
  role: "الدور",
  roleIsAccessChange: "وضع شخص في دور تغيير للصلاحيات، وهذا يضبط في شاشة الصلاحيات.",
  rolesShownHereBut: "تعرض الأدوار هنا لكنها تسند في شاشة الصلاحيات: فمنح شخص دورا هو منحه صلاحيات، وذلك حق قائم بذاته.",
  save: "حفظ",
  saving: "جار الحفظ…",
  searchNameCodeDepartment: "ابحث بالاسم أو الرقم الوظيفي أو القسم أو الدور",
  sectionIsnPartStudio: "لم يعد هذا القسم جزءا من هذا الاستوديو.",
  sending: "جار الإرسال…",
  status: "الحالة",
  ...
  studioSectionsWhereThey: "أقسام استوديوك. يمكن إدارة القائمة من البيانات الأساسية.",
  submit: "إرسال",
  thatIsNDays: (n: number) => `أي ${n === 1 ? "يوم واحد" : n === 2 ? "يومان" : n <= 10 ? `${n} أيام` : `${n} يوما`}.`,
  to: "إلى",
  type: "النوع",
  unassigned: "غير مسند",
