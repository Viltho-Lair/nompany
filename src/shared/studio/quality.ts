...
const ar: Strings = {
  ...
  documents: "الوثائق",
  draftNextRevision: "سود المراجعة التالية",
  footerSettings: "إعدادات التذييل…",
  headerSettings: "إعدادات الرأس…",
  heightMm: "الارتفاع (مم)",
  iHaveReadThis: "قرأت هذا",
  insertColumnLeft: "أدرج عمودا يمينه",
  insertColumnRight: "أدرج عمودا يساره",
  insertRowAbove: "أدرج صفا أعلاه",
  insertRowBelow: "أدرج صفا أدناه",
  issuedRevisionStays: "تبقى المراجعة الصادرة كما هي تماما حتى تنشر الجديدة فوقها.",
  issuingSupersedes: "إصدار هذه المراجعة يلغي ما قبلها. وتحفظ القديمة وتبقى قابلة للقراءة — وهذا ما يتيح القول بما كان الإجراء يقتضيه.",
  ...
  approved: "معتمدة",
  approver: "المعتمد",
  attachedStamped: "مرفقة — ستختم فوق اسمك.",
  ...
  documentCouldNotCreated: "تعذر إنشاء تلك الوثيقة.",
  documentCouldNotDeleted: "تعذر حذف تلك الوثيقة.",
  documentIssued: "صدرت هذه الوثيقة إليك.",
  documentNotAvailable: "هذه الوثيقة غير متاحة",
  documentTitle: "عنوان الوثيقة",
  documentWithdrawn: "سحبت هذه الوثيقة.",
  done: "تم",
  effective: "سارية من",
  everybodyAcknowledged: "· أقر الجميع",
  expired: "منتهية",
  ...
  heading3: "عنوان 3",
  history: "السجل",
  imageCouldnStored: "تعذر تخزين تلك الصورة.",
  ...
  linkLiveEveryOpen: "الرابط فعال. ويسجل كل فتح له.",
  loading: "جار التحميل…",
  loadingDocument: "جار تحميل الوثيقة…",
  ...
  marginWide: "واسع",
  margins: "الهوامش",
  mayHaveBeenDeleted: "ربما حذفت، أو أنك لا تملك الوصول إليها.",
  mergeSelected: "ادمج المحدد",
  middle: "وسط",
  middle2: "وسط",
  nTimesOpened: (n: number) => `فتح ${n === 1 ? "مرة واحدة" : n === 2 ? "مرتين" : n <= 10 ? `${n} مرات` : `${n} مرة`}`,
  nameRoleDateRecorded: "يسجل اسمك ودورك والتاريخ في الحالتين. والصورة زينة فوق ذلك.",
  neverEdited: "لم تحرر قط",
  ...
  nobodyNamedYet: "لم يسم أحد بعد. اختر من عليه العمل بهذه الوثيقة وسيبلغ عند إصدارها.",
  nobodyYet: "لا أحد بعد",
  none: "لا شيء",
  none2: "لا شيء",
  noneLinkBoundOne: "لا شيء. يرتبط الرابط بمراجعة واحدة وينتهي دائما.",
  ...
  nothingDistributedUntilIssued: "لا يوزع شيء حتى تصدر مراجعة.",
  ...
  nothingWrittenHereYet: "لم يكتب شيء هنا بعد.",
  nothingYet: "لا شيء بعد.",
  numberedList: "قائمة مرقمة",
  obsolete: "سحبت هذه الوثيقة.",
  ...
  revisionMovedOn: "تقدمت هذه المراجعة منذ رسم الشاشة. أعد التحميل لترى وضعها.",
  revisions: "المراجعات",
  revoke: "إبطال",
  revoked: "ملغى",
  right: "يمين",
  ...
  someone: "أحدهم",
  someone2: "أحدهم",
  splitCell: "قسم الخلية",
  startNextRevision: "ابدأ المراجعة التالية",
  startOneWillGet: "ابدأ واحدة وستأخذ رقمها تلقائيا.",
  ...
  toggleHeaderColumn: "بدل عمود الرأس",
  toggleHeaderRow: "بدل صف الرأس",
  toldWhenRevisionIssued: "يبلغون عند إصدار مراجعة، ويطلب منهم تأكيد قراءتها. ويعاد ضبط الإقرار مع كل مراجعة جديدة — فقراءة المراجعة الثانية لا تقول شيئا عن الثالثة.",
  top: "أعلى",
...
const AR_FIELD_LABELS: Record<string, string> = {
  ...
  "company.official": "بيانات التسجيل الرسمية",
