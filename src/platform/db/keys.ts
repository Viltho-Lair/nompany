...
export const SECTION_COLLECTIONS = {
  ...
  "projects-list": ["projects", "timesheets", "inspections", "projectCosts", "projectMilestones", "progressClaims", "siteReports"],
  "projects-sla": ["slas"],
  ...
  "finance-ledger": ["accounts", "journalEntries", "accountingPeriods", "bankStatementLines", "bankRules", "closeTicks", "deferralSchedules", "allocationRules"],
  ...
  "administration-master": ["locations", "departments", "costCodeLibrary", "clientTags", "itemCategories"],
