...
// "f" is a studio's public forms, /f/<slug>/<code> (19/09/2026).
const PLATFORM = new Set(["api", "_next", "super", "brand", "favicon.ico", "robots.txt", "sitemap.xml", "manifest.webmanifest", "studio", "c", "q", "f"]);
