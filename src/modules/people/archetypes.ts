...
export const ARCHETYPES: readonly Archetype[] = Object.freeze([
  ...
  },
  {
    ...
    grants: [
      ...
      // it, and signs off a drawer at the end of a shift — and, since Point of
      // Sale became a department (17/09/2026), reads its figures, its sales and
      ...
      // …and what those campaigns cost (21/09/2026).
      ["marketing.budget", "view"],
      // …and who the studio may contact (21/09/2026).
      ...
      // …and the artwork and copy made for them (22/09/2026).
      ["marketing.content", "full"],
      // …and the partners and influencers who carry them (22/09/2026).
      ["marketing.partners", "full"],
