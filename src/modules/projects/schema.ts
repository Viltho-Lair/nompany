...
// THE SLA SCHEMA MOVED TO MAINTENANCE (11/09/2026) — `SlaSchema` in
// modules/maintenance/schema.ts. The rows still live in `slas` under
// `projects-sla`; what moved is who reads and writes them.
