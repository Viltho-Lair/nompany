...
export const TERMS_SECTIONS = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "p", lead: "Free tier, seats, and fair use.", text: 'A free tier (the Standard package) is available for up to four (4) Authorised Users for its first three (3) months and requires no payment card. When that period ends the account becomes read-only unless a paid package has been selected. Where a plan is priced per Authorised User ("seat"), you must maintain a valid subscription for each individual accessing the Service. You may reassign a seat to a new user when a prior user no longer requires access, but seats must not be used as generic or shared logins. We may audit usage on reasonable notice to verify compliance.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "p", lead: "Failed payments and suspension.", text: "If a charge fails, we may retry the payment method and will notify you. If fees remain unpaid after the due date, the Service remains fully available for a grace period of three (3) months, during which we will send reminders. If fees are still unpaid when the grace period ends, the account becomes read-only — you can view and export Customer Data but cannot create or change it — until the outstanding amount is settled, at which point full access is restored. Non-payment never causes Customer Data to be deleted. We do not charge interest on late payments; we may, however, recover reasonable, documented costs of collection where permitted by law. Suspension does not relieve you of the obligation to pay accrued fees." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "table", head: ["Data category", "Retention period", "Trigger"], rows: [
        ...
        ["Customer Data of an unpaid or expired account", "Kept, read-only, until fees are paid or the owner requests deletion", "Non-payment / end of the free period"],
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "p", lead: "Data export window.", text: "You may export Customer Data in a commonly used, machine-readable format via self-service export tools or, on request, with reasonable assistance, at any time while your account exists — including while it is read-only and during the 30 days after a deletion request." },
