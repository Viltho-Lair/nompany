...
import {
  Card, CardHead, CardBody, Row, Col, StatCard, StatCardSkeleton, Skeleton, Icon, toneBg, toneInk,} from "../../_components/ui";
...
export default function NotificationsPanel() {
  ...
  return (
    <>
      {/* NO PAGE HEADER OF ITS OWN. This was a route with a title and a
          breadcrumb reading Home / Application / Notifications; it is a TAB now,
          and the settings page above it draws the one heading. Two headings
          stacked is how a moved screen announces that it was moved. Its action
          stays, because "mark all read" belongs to this list and to nothing
          else. */}
