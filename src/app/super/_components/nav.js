// The /super sidebar map — a 1:1 mirror of the reference console's navigation,
// re-rooted under /super. Groups render as captioned blocks; an item with
...
export const NAV = [
  ...
  {
    caption: "Tables",
    items: [{ label: "Data Tables", icon: "table", href: `${BASE}/tables/data-tables` }],
  },
  {
    caption: "Charts & Maps",
    items: [{ label: "Charts", icon: "pie", href: `${BASE}/charts/apex-charts` }],
  },
  {
    caption: "Other",
    items: [
