...
import { isCalendarProvider, enabledCalendarProviders } from "@/platform/auth/calendarProviders";
...
// of them.
export const GET = route({ auth: "user", name: "account/calendar" }, async ({ user }) => {
  ...
  return { connections, available: enabledCalendarProviders() };
});
