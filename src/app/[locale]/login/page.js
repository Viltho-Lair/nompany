    ...
    <section className="relative flex min-h-[85vh] items-center justify-center overflow-hidden bg-steel-900 px-5 py-24">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="mb-6 text-center">
          <h1 className="font-display text-3xl font-800 tracking-tight text-white sm:text-4xl">{t.loginTitle}</h1>
          <p className="mt-2 text-sm text-white/70">{t.loginSubtitle}</p>
        </div>
